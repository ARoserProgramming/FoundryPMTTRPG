...
PMTTRPG.damageTypes = {
 slash: {
   label: 'PMTTRPG.DAMAGE_TYPE.Slash',
    img: 'systems/pmttrpg/assets/imgs/damage/slash.svg',
    },
    pierce: {
    label: 'PMTTRPG.DAMAGE_TYPE.Pierce',
    img: 'systems/pmttrpg/assets/imgs/damage/pierce.svg',
    },
  blunt: {
    label: 'PMTTRPG.DAMAGE_TYPE.Blunt',
    img: 'systems/pmttrpg/assets/imgs/damage/blunt.svg',
  },
    burn: {
        label: 'PMTTRPG.DAMAGE_TYPE.Burn',
        img: 'systems/pmttrpg/assets/imgs/damage/burn.svg',
    },
  sinking: {
    label: 'PMTTRPG.DAMAGE_TYPE.Sinking',
    img: 'systems/pmttrpg/assets/imgs/damage/sinking.svg',
  },
  rupture: {
    label: 'PMTTRPG.DAMAGE_TYPE.Rupture',
    img: 'systems/pmttrpg/assets/imgs/damage/rupture.svg',
  },
  frostbite: {
    label: 'PMTTRPG.DAMAGE_TYPE.Frostbite',
    img: 'systems/pmttrpg/assets/imgs/damage/frostbite.svg',
  },
  bleed:{
    label: 'PMTTRPG.DAMAGE_TYPE.Bleed',
    img: 'systems/pmttrpg/assets/imgs/damage/bleed.svg',
  },
  tremor:{
    label: 'PMTTRPG.DAMAGE_TYPE.Tremor',
    img: 'systems/pmttrpg/assets/imgs/damage/tremor.svg',
  },
  critical:{
    label: 'PMTTRPG.DAMAGE_TYPE.Critical',
    img: 'systems/pmttrpg/assets/imgs/damage/critical.svg',
  },
  devastating:{
   label: 'PMTTRPG.DAMAGE_TYPE.Devastating',
    img: 'systems/pmttrpg/assets/imgs/damage/devastating.svg',
 },
  physical:{
    label: 'PMTTRPG.DAMAGE_TYPE.Physical',
    img: 'systems/pmttrpg/assets/imgs/damage/physical.svg',
  },
  force:{
    label: 'PMTTRPG.DAMAGE_TYPE.Force',
    img: 'systems/pmttrpg/assets/imgs/damage/force.svg',
  },
  falling:{
    label: 'PMTTRPG.DAMAGE_TYPE.Falling',
    img: 'systems/pmttrpg/assets/imgs/damage/falling.svg',
  }
}
...
PMTTRPG.conditions = {
    ...
    devastation: {
        name: 'PMTTRPG.Condition.Devastating',
