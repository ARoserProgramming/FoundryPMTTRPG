...
export default class PMTTRPGActiveEffect extends ActiveEffect{
     ...
     * @param {PMTTRPGActor} actor      The actor to check against for rendering
     ...
     * @param {PMTTRPGActor} affected The actor affected by the status
     * @param {PMTTRPGActor} source The actor imposing the status
