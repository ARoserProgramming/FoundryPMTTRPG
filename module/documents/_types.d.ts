...
import { PMTTRPGActiveEffect, PMTTRPGCombatantGroup, PMTTRPGCombatant, PMTTRPGItem } from "./_module.mjs";
...
declare module "@client/documents/_module.mjs" {
    interface BaseActor<Model extends ActorModel = ActorModel> extends ActorData {
        ...
        items: Collection<string, PMTTRPGItem>;
        effects: Collection<string, PMTTRPGActiveEffect>;
    }
    ...
    interface BaseCombat extends CombatData {
        ...
        combatants: Collection<string, PMTTRPGCombatant>;
        groups: Collection<string, PMTTRPGCombatantGroup>
    }
