 ...
 */
export default class PMTTRPGNpc extends PMTTRPGDataModel {
    ...
    static defineSchema() {
        ...
        schema.sanity_points = new fields.SchemaField({
            ...
            temporal: new fields.NumberField({initial:0, value: 0, nullable: false, integer: true}),
        });
    ...
    prepareDerivedData() {
        ...
        if (this.abilities) {
            for (const key in this.abilities) {
                ...
                this.abilities[key].tooltip = CONFIG.PMTTRPG.abilityTooltips[key];
            }
        }
